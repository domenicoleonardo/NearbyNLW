...
@Composable
//essa função será disparada toda vez que o usuário selecionar algum dos filtros
fun NearbyCategoryFilterChipList(
    modifier: Modifier = Modifier,
    categories: List<Category>,
    onSelectedCategoryChanged: (Category) -> Unit, // Unit indica que não retorna nada

) {
    //será armazenado o id da category
    var selectedCategoryId by remember { // Lembra o ID selecionado durante a recomposição
